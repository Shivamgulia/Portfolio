...
const Projects = [
  {
    ...
    work: [
      'Authentication and signup using Google Identity Services, and implemented remember me',
      'Implemented QR Scanner in react with qr scan library',
    ],
  },
  {
    id: 2,
    ...
    work: [
      'Create a Restful API using SpringBoot with MongoDb',
      'Developed to websites one for clients to order food and other for restaurant Using React JS',
      'Used Routing to create a multi-page application using React Js',
      "Implementation of 3 roles for different users (Student, Guard, Admin) different roles have different accesses (like student can rent cycle, guard can return cycles, admin can add or delete student ,guard accounts and also cycle id's)",
    ],
  },
  {
    id: 4,
    ...
    work: [
      ...
      'Implemented spring security and JSON Web Token(JWT) for an authentication system for cross platform api',
      'Implemented Google captcha to avoid phishing',
      'Designed and implemented front end using React Js',
      'MySql being used as the database',
    ],
  },
  {
    id: 3,
    ...
    work: [
      'Implemented authentication system in React using firebase authentication system',
      'Implemented remember me using browser storage',
    ],
  },
];
